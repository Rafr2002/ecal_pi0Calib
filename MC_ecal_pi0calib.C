...
//*Uncalibrated data(FIRST) event loop
    for (Long64_t i = 0; i < nEvents; i++) {
        ...
        // int nMax=nclus; double best_mass = 0.0;

        // indices of N best 
        // std::vector<int>(best_indices);

        // best_pair_minMass_topN(ecal_e, clus_nblk, ecal_x, ecal_y, clus_a_time, nclus,  nMax, best_icl, best_jcl, best_dt, best_mass);
...
//**Calibrated data(SECOND) event loop
    for (Long64_t i = 0; i < nEvents; i++) {
        ...
        // double best_mass = 0.0;
        // best_pair_chi2(ecal_e, clus_nblk, ecal_x, ecal_y,
            //    clus_a_time, nclus, best_icl, best_jcl,
            //    best_dt, best_mass);
